...
include('butang-saiz-sahaja.php');
$tambahan ="";

# Mendapatkan data menu berdasarkan kategori yang dipilih 
if(!empty($_GET['jenis'])) {
    $tambahan = "where id_kategori= '".mysqli_real_escape_string($condb, $_GET['jenis'])."'";
}
...
<!-- Memaparkan menu dalam bentuk jadual -->
 <table align = 'center'    border ='1'     width = '50%'   id='saiz'>
    <caption>
    ...
    <tr>
        ...
        <td width='20%'>
            <!-- Butang tempahan -->
             <a href = 'tempahan-tambah.php?page=menu&jenis=<?=$m['id_kategori']?> & id_menu=<?=$m['id_menu']?> ' > Tambah Cart </a>
        </td>
    </tr>
